...
image:
  path:                                 /assets/image/pages/straeter/torsten-straeter.jpg
  width:                                1920
  height:                               1200
...
comments:                               false
regenerate:                             false
permalink:                              /pages/public/video/tv-highlights/straeter/
...
resource_options:
  - attic:
      padding_top:                      650
      slides:
        - url:                          /assets/image/pages/straeter/torsten-straeter.jpg
          alt:                          Torsten Sträter
---
...
Quelle: https://de.wikipedia.org/wiki/Torsten_Str%C3%A4ter[Wikipedia, {browser-window--new}]
...
== Sträter Show und Gäste

Torsten Sträter lädt ein zu *einem Abend unter Freunden* im Mülheimer Hafen
in Köln. Nach einem Stand-up-Teil heißt er im Verlauf der Show einen
prominenten und einen weniger prominenten Gast willkommen.
...
Einsparen von Zeit ist revolutionär.

Tino Bomelino präsentiert seinen Erfolgskurs – für alle, die Bock haben auf
Erfolg. Morgens ganz entspannt Kaffee machen? Der absolut falsche Weg!
...
Manche Gegenteile sind ganz offensichtlich, Tino Bomelino hat ein paar Paare
von Gegenteilen mitgebracht, die weniger offensichtlich sind. Die möglicher
Weise wichtig sind.
...
die *Teleportier-Frau* immer zu spät? Und was findet *Super-Mann*
nicht super?

Thema Superhelden unklar? Tino Bomelino gibt Antworten.
...
Käse mit Pizza im Rand, ein Ausmalbuch für Erwachsene, Tiervermietung und
ein Pyramiden-Bastelplan, der dich und deine Freunde garantiert nicht in ein
Pyramiden-System stürzen wird. Bomelino bietet viele gute Ideen für die
Eigenständigkeit auf die man kommen kann - irgendwann.
